...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $update = $pdo->prepare("UPDATE events SET title=?, category=?, event_date=?, location=?, description=?, total_seats=? WHERE id=?");
    $update->execute([
        $_POST['title'],
        $_POST['category'],
        $_POST['event_date'],
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" id="total_seats" name="total_seats" min="1" value="<?= $event['total_seats'] ?? 100 ?>" required>
